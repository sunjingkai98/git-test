    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#last").click(function () {
                ...
                $.get("${pageContext.request.contextPath}/product/${sId}/${currectPage-1}",function (data) {
                    $("#middle1").html(data);
                });
            });
            /*下一页超链接*/
...
<body>
<div style="margin:10px auto;height:4% ;width:100%;text-align: center;
        background-color:rgb(255,50,40);padding-top: 5px;color: white">
    <c:choose>
